...
public class PgAdapterDriver implements java.sql.Driver {
  ...
  private static Connection makeConnection(String url, Properties props) throws SQLException {
    return new PgAdapterConnection(hostSpecs(props), user(props), database(props), props, url);
  }
  ...
  public static void register() throws SQLException {
    ...
    PgAdapterDriver registeredDriver = new PgAdapterDriver();
    DriverManager.registerDriver(registeredDriver);
    PgAdapterDriver.registeredDriver = registeredDriver;
  }
